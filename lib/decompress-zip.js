...
Zip.prototype = {
    ...
    extractUncompressed: function (file, destination) {
        ...
        if (file.directoryEntry.uncompressedSize === 0) {
            ...
            var input = fs.createReadStream(this.filename, {start: file.dataOffset, end: file.dataOffset + file.directoryEntry.uncompressedSize - 1});
            writer = this.pipePromise.bind(this, input, destination);
        }
